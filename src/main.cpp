...
int main() {
    ...
    EVPCipher::test_evp_cipher(EVP_aes_128_cbc(), input_buffer);
    EVPCipher::test_evp_cipher(EVP_aes_192_cbc(), input_buffer);
    EVPCipher::test_evp_cipher(EVP_aes_256_cbc(), input_buffer);
